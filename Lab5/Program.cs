        ...
        static void Main(string[] args)
        {
            ...
            while (!bQuit)
            {
                ...
                if (stopWatch.Elapsed.TotalSeconds > 0.33)
                {
                    ...
                    Console.WriteLine(vehicles[0].force.x.ToString() + " " + vehicles[0].drag.x.ToString() + " " + vehicles[0].acceleration.x.ToString() + " " + vehicles[0].velocity.x.ToString()
                        + " " + vehicles[0].position.x.ToString());
                    ...
                    if (bSimulating)
                    {
                        Physics.Instance.Iterate(stopWatch.Elapsed.TotalSeconds, vehicles);
                    }
